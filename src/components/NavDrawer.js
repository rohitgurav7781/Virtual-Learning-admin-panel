...
import { Badge, Button, ListItemText, Menu, MenuItem } from "@mui/material";
...
export default function MiniDrawer() {
  ...
  const [userName, setUserName] = useState(""); // Assuming fullName should be used
  ...
  // Update useEffect to fetch user info when user logs in
  useEffect(() => {
    const loggedInUser = JSON.parse(sessionStorage.getItem("user"));
    if (loggedInUser && loggedInUser.accessToken) {
      setUser(loggedInUser);
        ...
        >
          <Toolbar>
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              ...
              <IconButton size="large" sx={{ color: Colors.black }}>
                <Badge badgeContent={successCount} color="success">
                  <EventAvailableIcon
                    style={{ color: "#012970" }}
              ...
              >
                <Badge badgeContent={notifications.length} color="primary">
                  <NotificationsNoneIcon style={{ color: "#012970" }} />
                </Badge>
              </IconButton>
              <Menu
              ...
              <IconButton
                ...
                sx={{ color: Colors.black, cursor: "pointer" }}
              >
                <AccountCircle style={{ color: "#012970" }} />
                <Typography sx={{ color: "#899bbd" }}>{userName}</Typography>
              </IconButton>
            </Box>
